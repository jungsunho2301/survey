...
// ...Q1~Q4, Q5, Q6, Q7 처리 코드 끝

// -------------------------
// 모두 아니오면 조사생략
// -------------------------
const allNo = ["q1","q2","q3","q4","q5","q6","q7","depart48","boarding","dock"].every(
  q => f.get(q) === "no" || f.get(q) === null
);

if (allNo) {
  return showResult("조사생략","검역 관련 특이사항 없음, 위험 요인 없음");
}
