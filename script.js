...
const q5Data = {
  ...
  china_yn_q5: {l:"중국(원난성)", d:"AI", day:10}, 
  china_js_q5: {l:"중국(장시성)", d:"AI", day:10}, 
...
const q6Data = {
  ...
  angola_q6: [{d:"콜레라", day:5}, {d:"황열", day:6}, {d:"폴리오", day:21}, {d:"홍역", day:21}, {d:"뎅기열", day:7}, {d:"에볼라", day:21}],
  haiti_q6: [{d:"콜레라", day:5}],
  zambia_q6: [{d:"콜레라", day:5}, {d:"홍역", day:21}, {d:"에볼라", day:21}],
  zimbabwe_q6: [{d:"콜레라", day:5}],
  chad_q6: [{d:"콜레라", day:5}, {d:"황열", day:6}, {d:"폴리오", day:21}, {d:"홍역", day:21}, {d:"뎅기열", day:7}],
  comoros_q6: [{d:"홍역", day:21}, {d:"뎅기열", day:7}, {d:"치쿤구니야열", day:12}],
  ivory_coast_q6: [{d:"콜레라", day:5}, {d:"황열", day:6}, {d:"홍역", day:21}, {d:"뎅기열", day:7}],
  congo_q6: [{d:"콜레라", day:5}, {d:"황열", day:6}, {d:"홍역", day:21}, {d:"에볼라", day:21}],
  togo_q6: [{d:"콜레라", day:5}, {d:"황열", day:6}, {d:"홍역", day:21}, {d:"폴리오", day:21}],
...
function regionLabelQ6(v) {
  const l = {
    ...
    mada_q6: "마다가스카르", malawi_q6: "말라위", malaysia_q6: "말레이시아", 
    ...
    moldova_q6: "몰도바", maldives_q6: "몰디브", mongolia_q6: "몽골", 
    ...
    haiti_q6: "아이티", afghanistan_q6: "아프가니스탄", antigua_q6: "앤티가 바부다", 
